...
public class ElephantEntityInitializer implements ModInitializer {
    ...
    public static final EntityType<ElephantEntity> ELEPHANT = Registry.register(
            ...
            new Identifier("example", "elephant"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, ElephantEntity::new).dimensions(EntityDimensions.fixed(0.75f, 0.75f)).build()
    );
    ...
    public void onInitialize() {
         ...
         */
        FabricDefaultAttributeRegistry.register(ELEPHANT, ElephantEntity.createMobAttributes());
    }
}